...
import { educFiImageLoader } from '../utils/util';
...
const PostCard = ({ post }) => (
  <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
    ...
    <h1 className="transition duration-700 text-center mb-8 cursor-pointer hover:text-pink-600 text-black text-3xl font-semibold">
